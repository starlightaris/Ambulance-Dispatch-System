 ...
 *
 * Contains the assessment identifier, assigned triage category, calculated
 * score, position in the active queue, and result generation time.
 */
public class TriageResponseDTO {
     ...
     *
     * @param id unique identifier of the persisted assessment
